                                                    ...
                                                    @if($f->email == Auth::user()->email ) --}}
                                                        ...
                                                        <div class="col-md-3 mb-4">
                                                            <div class="card text-left">
                                                                <div class="card-body">
                                                                    <h5 class="card-title text-center">{{ $item->attendence_date }}</h5>
                                                                ...
                                                                <a class="btn btn-md btn-primary m-2" href="{{ route('attendance.details',[$item->attendence_date,$course_id]) }}">View</a>
